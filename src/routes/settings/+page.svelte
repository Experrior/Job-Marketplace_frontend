...
<div class="settings-container">
    <aside class="sidebar">
        ...
        <ul>
            ...
            <li on:click={() => navigateTo('savedOffers')} class:selected={currentPage === 'savedOffers'}>
                Saved Offers
            </li>
            <li on:click={() => navigateTo('myApplications')} class:selected={currentPage === 'myApplications'}>
                My Applications
            </li>
