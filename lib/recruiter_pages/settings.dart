...
void main() {
  runApp(RecruiterSettingsPage());
}

class RecruiterSettingsPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        body: RecruiterSettingsScreen(),
      ),
    );
  }
}
...
class RecruiterSettingsScreen extends StatefulWidget {
  @override
  _RecruiterSettingsScreen createState() => _RecruiterSettingsScreen();
}

class _RecruiterSettingsScreen extends State<RecruiterSettingsScreen> {
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => RecruiterAnalyticsPage()),
                );
              },
              child: Text("Salaries"),
            ),
            ...
            IconButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => RecruiterSettingsPage()),
                );
              },
            ),
          ],
